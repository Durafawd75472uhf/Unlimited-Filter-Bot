...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("MainChannel🎭", url="https://t.me/keralaOttMoviesPlatform"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("Cinema update 🎉", url="https://t.me/cinemaupdatechannel"),
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://t.me/+9AHMDl5MEM4wNWU1")
                ],
                [
